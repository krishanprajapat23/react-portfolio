...
const Header = () => {
    ...
    return (
        <>
            ...
            className={`text-(--primary-t-color)} w-full z-99 text-(--primary-t-color) 
                ${isSticky ? "fixed top-0 bg-[hsl(60deg_33.33%_1.18%/42%)] backdrop-blur-md shadow-lg" : "relative bg-transparent pt-5"
            }`}>
